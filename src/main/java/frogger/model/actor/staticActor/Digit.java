 ...
 * <h2> Digit </h2>
 * 
 * <p> The {@link Digit} class is used to create the single bit of scoreBoard and change the image when {@link Score} changed.
 * 
 * <p> A {@link Digit} object is set in {@link Map}. It represents the current {@link Score} of game and change the points when {@link Score} added or subtracted.
 *
...
public class Digit extends StaticActor{
	 ...
	 * 
	 * <p> This constructor sets the {@link Digit} in the given position {@code x} and {@code y} in the {@link Map}.

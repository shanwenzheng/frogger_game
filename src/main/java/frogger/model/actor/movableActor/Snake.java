 ...
 * <h2> Snake </h2>
 *
 * <p> The {@link Snake} class is used to create the snake object.
 *
 * <p> A {@link Snake} object is set in {@link frogger.model.Map}. It can move with the constant speed as time goes on.
 ...
 * @see Frog
 */
public class Snake extends MovableActor {

    /**
     * <p> The constructor of {@link Snake} class to generate instance
     *
     * <p> This constructor sets the {@link Snake} in the given position {@code x} and {@code y} in the {@link frogger.model.Map}.
     * Set the constant speed in the given {@code speed}.
     * Set the initial image with the given {@code size}.
     *
     * @param imageLink	The path of image needed to be set to {@link Snake}
     ...
     * @param s			The speed of {@link Snake} movement
     */
    public Snake(String imageLink, int size, double  xpos, double  ypos, double  s) {
        super(xpos, ypos, s);
     ...
     *  1. move the {@link Snake}
     *  2. check whether {@link Snake} has touched the right or left wall
     *  3. check whether {@link Snake} has touched the {@link Frog}
     *

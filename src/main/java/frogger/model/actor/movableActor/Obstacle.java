 ...
 * 
 * <p> A {@link Obstacle} object is set in {@link Map}. It can move with the constant speed as time goes on.
...
public class Obstacle extends MovableActor {
	 ...
	 * 
	 * <p> This constructor sets the {@link Obstacle} in the given position {@code x} and {@code y} in the {@link Map}.

 ...
 * 
 * <p> A {@link Log} object is set in {@link Map}. It can move with the constant speed as time goes on.
...
public class Log extends MovableActor {
	 ...
	 * 
	 * <p> This constructor sets the {@link Log} in the given position {@code x} and {@code y} in the {@link Map}.

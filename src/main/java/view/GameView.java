...
public class GameView {
	...
	public void drawMap() {
		...
		background.getChildren().add(new Turtle(500, 376, -1, 130, 130));
		background.getChildren().add(new Turtle(300, 376, -1, 130, 130));
		background.getChildren().add(new WetTurtle(700, 376, -1, 130, 130));
		...
		background.getChildren().add(new Obstacle("images/truck1"+"Right.png", 600, 649, 1, 120, 120));
		background.getChildren().add(new Obstacle("images/car1Left.png", 100, 597, -1, 50, 50));
		background.getChildren().add(new Obstacle("images/car1Left.png", 250, 597, -1, 50, 50));
		background.getChildren().add(new Obstacle("images/car1Left.png", 400, 597, -1, 50, 50));
		background.getChildren().add(new Obstacle("images/car1Left.png", 550, 597, -1, 50, 50));
